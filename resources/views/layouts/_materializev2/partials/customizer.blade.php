    ...
    <div class="offcanvas-body p-4">
        <div class="theme-option pb-4">
            ...
            <div class="d-flex align-items-center gap-3 my-3">
                <a href="javascript:void(0)"  onclick="toggleTheme('{{asset("_materialize_v2/dist/css/style.min.css")}}')"  class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 light-theme text-dark">
                    <i class="ti ti-brightness-up fs-7 text-primary"></i>
                    <span class="text-dark">Light</span>
                </a>
                <a href="javascript:void(0)" onclick="toggleTheme('{{asset("style-dark.min.css")}}')" class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2 dark-theme text-dark">
        ...
        <div class="theme-direction pb-4">
            ...
            <div class="d-flex align-items-center gap-3 my-3">
                <a href="{{route('home')}}" class="rounded-2 p-9 customizer-box hover-img d-flex align-items-center gap-2">
